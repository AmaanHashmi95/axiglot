 ...
 return (
   <main className="flex w-full min-w-0 justify-center">
     <div className="w-full min-w-0 space-y-5 max-w-5xl">
       ...
       <div className="rounded-2xl bg-card p-5 shadow-sm">
       <div className="flex items-center mb-5">
           <h1 className="text-left text-2xl font-bold">Urdu</h1>
           <Image
             src={pakistan}
             alt="Urdu Icon"
             width={30}
         ...
         <Link href="/courses/a1punjabi">
           ...
           <div className="rounded-2xl bg-gradient-to-r from-[#00605b] to-[#cfcfcf] p-5 shadow-sm w-full">
             <h1 className="text-left text-xl font-bold">B1 Urdu</h1>
           </div>
           <div className="rounded-2xl bg-gradient-to-r from-[#00605b] to-[#cfcfcf] p-5 shadow-sm w-full">
             <h1 className="text-left text-xl font-bold">B2 Urdu</h1>
           </div>
           <div className="rounded-2xl bg-gradient-to-r from-[#00605b] to-[#cfcfcf] p-5 shadow-sm w-full">
             <h1 className="text-left text-xl font-bold">C1 Urdu</h1>
           </div>
         </div>
       </div>
